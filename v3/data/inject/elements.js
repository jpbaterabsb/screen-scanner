  ...
  OPEN|http://127.0.0.1:8080?data=&content;|`
        ...
        shadow.innerHTML = `
          ...
          <div id="body">
            ...
            <div id="result-ai" data-msg="Please wait result from AI..."></div>
            <div id="tools">
      ...
      buildAI(text) {
        ...
        this.shadowRoot.getElementById('result-ai').append(doc.body.childNodes[0]);
      }
      message(value) {
      ...
      connectedCallback() {
        ...
        this.addEventListener('command', e => {
          ...
          console.log("🚀 ~ file: elements.js:547 ~ OCRResult ~ connectedCallback ~ args:", args)
          console.log("🚀 ~ file: elements.js:547 ~ OCRResult ~ connectedCallback ~ name:", name)
          this[name](...args);
        });
        // constants
